...
export default async function DashboardPage() {
  ...
  const statCards = isAdmin
    ? [
        { label: "전체 자산", value: stats[0], icon: "M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4", color: "indigo" },
        { label: "전체 요청", value: stats[1], icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2", color: "amber" },
        { label: "전체 딜", value: stats[2], icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z", color: "slate" },
        { label: "거래 성사", value: stats[3], icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", color: "emerald" },
      ]
    : [
        { label: "내 자산", value: stats[0], icon: "M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4", color: "indigo" },
        { label: "구매 요청", value: stats[1], icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2", color: "amber" },
        { label: "진행 딜", value: stats[2], icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z", color: "slate" },
        { label: "거래 성사", value: stats[3], icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", color: "emerald" },
      ];
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-black text-slate-900 tracking-tight">안녕하세요, {user.name}님</h1>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 mb-8">
        {statCards.map((card) => (
          <div key={card.label} className="bg-white border border-slate-200 rounded-2xl p-5 hover:shadow-sm transition-shadow">
            <div className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-lg mb-4 ${iconBg[card.color]}`}>
            ...
            <p className="text-3xl font-black text-slate-900">
              {card.value}<span className="text-lg font-semibold text-slate-400 ml-1">건</span>
            </p>
          </div>
        ))}
      </div>
  ...
  return (
    <section>
      <div className="flex items-center justify-between mb-3">
        ...
        <Link href={href} className="text-xs text-indigo-600 font-semibold hover:underline">전체 보기 →</Link>
      </div>
