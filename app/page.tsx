    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="pt-20 bg-white">
        <div className="max-w-6xl mx-auto px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-black text-indigo-700 leading-tight mb-5 tracking-tight">
              쓰지 않는 장비를<br />수익으로.
            </h1>
        ...
        <div className="max-w-6xl mx-auto px-8 py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={item.label} className="bg-white border border-gray-200 rounded-xl p-5 flex items-center gap-4">
      ...
      <section className="max-w-6xl mx-auto px-8 py-24">
        <h2 className="text-2xl font-black text-slate-900 text-center mb-14 tracking-tight">3단계로 거래가 완료됩니다</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={item.step} className="relative flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-6">
              {i < 2 && (
      ...
      <section className="bg-gray-50 border-y border-gray-100 py-24">
        <div className="max-w-6xl mx-auto px-8">
          <h2 className="text-2xl font-black text-slate-900 text-center mb-12 tracking-tight">이런 분께 맞습니다.</h2>
      ...
      <section className="max-w-6xl mx-auto px-8 py-24">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1">
            <p className="text-xs font-bold text-indigo-600 uppercase tracking-widest mb-3">Additional Service</p>
      ...
      <section className="bg-indigo-700 py-24">
        <div className="max-w-3xl mx-auto px-8 text-center">
          ...
          <p className="text-indigo-200 mb-8 text-base">등록은 무료입니다. 매칭은 ROOT가 합니다.</p>
